          ...
          <Row>
            <Col lg="12">
              <div className="tab_wrapper">
                <h6
                  className={`${view === "description" ? "active_desc" : ""}`}
                  onClick={() => setView("description")}
                >
                  Description{" "}
                </h6>
                <h6
                  className={`${view === "review" ? "active_desc:" : ""}`}
                        ...
                        <div className="form_group">
                          ...
                          <div className="form_group">
                            <textarea
                              ...
                              rows={4}
                              type="text"
                              placeholder="let me know how you feel about this drink ^^"
                            />
                          </div>
                        </div>
            ...
            <Col lg="12" className="mt-6">
              <h2 className="relate_content">
                {" "}
                Other water dishes you may like
              </h2>
            </Col>
